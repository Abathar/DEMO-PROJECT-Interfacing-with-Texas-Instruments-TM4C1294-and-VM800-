...
#define LEDOn()  GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, CLP_D1_PIN);

#define LEDOff() GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, 0)
...
void ComGauge(int16_t x, int16_t y, int16_t r, uint16_t options, uint16_t major, uint16_t minor, uint16_t val, uint16_t range)
{
